...
Ext.define('Example.view.Win', {
    ...
    listeners: {
        'show': function (win) {
             if (typeof(win.entityid) != 'undefined') {
                ...
                Ext.Ajax.request({
                    url: Ext.getContext() + '/example/getById',
                    type: 'GET',
                    async: false,
    ...
    saveBtnClick:function(){
        ...
        if(values.id===''){
            me.saveToDB(true,me,Ext.getContext()+'/example/save',values,false);
        }else {
            me.saveToDB(true,me,Ext.getContext()+'/example/modify',values,false);
        }
