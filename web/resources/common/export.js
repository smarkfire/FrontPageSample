...
Ext.override(Ext.grid.GridPanel, {
    getExcelXml: function(includeHidden) {
        var totalWidth = 1000;//this.getColumnModel().getTotalWidth(includeHidden);
        var excelTitle = "";
    ...
    createWorksheet: function(includeHidden) {
        ...
        for (var i = 0; i < colCount; i++) {
             if ((cm[i].dataIndex != '' && cm[i].dataIndex!=null)
                && (includeHidden || !cm[i].isHidden())) {
                var w = cm[i].defaultWidth ;//cm.getColumnWidth(i)
                ...
                else
                {
                    ...
                    headerXml += '<ss:Cell ss:StyleID="headercell">' +
                     ...
                     var fld = this.store.model.prototype.fields.get(cm[i].dataIndex);//this.store.recordType.prototype.fields.get(cm[i].dataIndex);
                     switch(fld.type) {
                        case "int":
        ...
        for (var i = 0, it = this.store.data.items, l = it.length; i < l; i++) {
            ...
            for (var j = 0; j < colCount; j++) {
                if ((cm[j].dataIndex != '')
                    ...
                    var v = r[cm[j].dataIndex];//r[cm.getDataIndex(j)];
                    if (cellType[k] !== "None") {
